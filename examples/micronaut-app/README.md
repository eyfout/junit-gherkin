...
and a [@Client](src/main/kotlin/ht/eyfout/example/client/dmv/DMVClient.kt) 
that allows consumers to fetch information about a vehicle and their manufacturer.
...
see [example tests](src/test/kotlin/ht/eyfout).
